...
function getElIcon(type) {
  var icons = {heading:'H',text:'T',image:'🖼',button:'⬡',spacer:'↕',divider:'─',video:'▶',gallery:'⊞',icon_box:'⚡',counter:'123',alert:'!',html:'</>',posts_grid:'⊟'};
  return icons[type] || '?';
}
...
function gbSave() {
  ...
  fetch(GB.base + '/manage/pages/' + GB.pageId + '/builder/save', {
    method: 'POST',
