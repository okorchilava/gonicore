...
/* Full-width: the section AND media (sliders, images, video, galleries) bleed
   edge-to-edge. Only text-like content keeps a responsive side gutter so it
   doesn't glue to the screen edges. */
...
.gb-full-width .gb-heading,
.gb-full-width .gb-text,
.gb-full-width .gb-button,
.gb-full-width .gb-icon-box,
.gb-full-width .gb-counter,
.gb-full-width .gb-alert{
