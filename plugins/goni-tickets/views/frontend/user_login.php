...
<div class="gt-auth-page">
    ...
    <div class="gt-auth-box">
        ...
        <div class="gt-auth-title">შესვლა</div>
        <div class="gt-auth-sub">გონი ტიქეთსის ანგარიში</div>

        <?php if (!empty($error)): ?>
        <div class="gt-auth-error">⚠ <?= e($error) ?></div>
        <?php endif ?>

        <form method="POST" action="<?= e($base) ?>/tickets/login">
            <?php if ($redirect): ?>
            ...
            <div class="gt-auth-field">
                ...
                <input class="gt-auth-input" type="email" name="email" required autocomplete="email" placeholder="you@example.com">
            </div>
            <div class="gt-auth-field">
                <label class="gt-auth-label">პაროლი</label>
                <input class="gt-auth-input" type="password" name="password" required autocomplete="current-password" placeholder="••••••">
            </div>
            <button type="submit" class="gt-auth-btn">შესვლა →</button>
        </form>

        <div class="gt-auth-footer">
            ანგარიში არ გაქვს?
            <a href="<?= e($base) ?>/tickets/register">რეგისტრაცია</a>
        </div>
    </div>
</div>
